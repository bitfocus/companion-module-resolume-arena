...
/////////////////////////////////////////////////
	...
	async clipVolumeFeedbackCallback(feedback: CompanionFeedbackInfo, _context: CompanionCommonCallbackContext): Promise<CompanionAdvancedFeedbackResult> {
	...
	async clipVolumeFeedbackSubscribe(feedback: CompanionFeedbackInfo, _context: CompanionCommonCallbackContext) {
		const layer = +(feedback.options.layer as string);
		const column = +(feedback.options.column as string);
	...
	async clipVolumeFeedbackUnsubscribe(feedback: CompanionFeedbackInfo, _context: CompanionCommonCallbackContext) {
		const layer = +(feedback.options.layer as string);
		const column = +(feedback.options.column as string);
		if (ClipId.isValid(layer, column)) {
			const idString = new ClipId(layer, column).getIdString();
	...
	async clipOpacityFeedbackCallback(feedback: CompanionFeedbackInfo, _context: CompanionCommonCallbackContext): Promise<CompanionAdvancedFeedbackResult> {
		const layer = +(feedback.options.layer as string);
		const column = +(feedback.options.column as string);
		if (layer === 0 || column === 0) {
			return {text: '?'};
	...
	async clipOpacityFeedbackSubscribe(feedback: CompanionFeedbackInfo, _context: CompanionCommonCallbackContext) {
		const layer = +(feedback.options.layer as string);
		const column = +(feedback.options.column as string);
		if (ClipId.isValid(layer, column)) {
			const idString = new ClipId(layer, column).getIdString();
	...
	async clipOpacityFeedbackUnsubscribe(feedback: CompanionFeedbackInfo, _context: CompanionCommonCallbackContext) {
		const layer = +(feedback.options.layer as string);
		const column = +(feedback.options.column as string);
		if (ClipId.isValid(layer, column)) {
			const idString = new ClipId(layer, column).getIdString();
	...
	async clipDetailsFeedbackCallback(feedback: CompanionFeedbackInfo, _context: CompanionCommonCallbackContext): Promise<CompanionAdvancedFeedbackResult> {
		const layer = +(feedback.options.layer as string);
		const column = +(feedback.options.column as string);
	...
	async clipDetailsFeedbackSubscribe(feedback: CompanionFeedbackInfo, _context: CompanionCommonCallbackContext) {
		const layer = +(feedback.options.layer as string);
		const column = +(feedback.options.column as string);
	...
	async clipDetailsFeedbackUnsubscribe(feedback: CompanionFeedbackInfo, _context: CompanionCommonCallbackContext) {
		const layer = +(feedback.options.layer as string);
		const column = +(feedback.options.column as string);
	...
	async clipConnectedFeedbackCallback(feedback: CompanionFeedbackInfo, _context: CompanionCommonCallbackContext): Promise<CompanionAdvancedFeedbackResult> {
		const layer = +(feedback.options.layer as string);
		const column = +(feedback.options.column as string);
	...
	async clipSelectedFeedbackCallback(feedback: CompanionFeedbackInfo, _context: CompanionCommonCallbackContext): Promise<boolean> {
		const layer = +(feedback.options.layer as string);
		const column = +(feedback.options.column as string);
	...
	async clipSpeedFeedbackCallback(feedback: CompanionFeedbackInfo, _context: CompanionCommonCallbackContext): Promise<CompanionAdvancedFeedbackResult> {
		const layer = +(feedback.options.layer as string);
		const column = +(feedback.options.column as string);
		if (layer === 0 || column === 0) {
			return {text: '?'};
	...
	async clipSpeedFeedbackSubscribe(feedback: CompanionFeedbackInfo, _context: CompanionCommonCallbackContext) {
		const layer = +(feedback.options.layer as string);
		const column = +(feedback.options.column as string);
	...
	async clipSpeedFeedbackUnsubscribe(feedback: CompanionFeedbackInfo, _context: CompanionCommonCallbackContext) {
		const layer = +(feedback.options.layer as string);
		const column = +(feedback.options.column as string);
	...
	async clipTransportPositionFeedbackCallback(feedback: CompanionFeedbackInfo, _context: CompanionCommonCallbackContext): Promise<CompanionAdvancedFeedbackResult> {
		const layer = +(feedback.options.layer as string);
		const column = +(feedback.options.column as string);
