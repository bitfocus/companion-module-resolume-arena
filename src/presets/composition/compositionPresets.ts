...
export function getCompositionApiPresetBundle(category: string): DomainPresetBundle {
	...
	// Transport
	presets.disconnectAll = disconnectAllPreset(category);  transportIds.push('disconnectAll');
	...
	if (transportIds.length) groups.push({id: 'composition_transport', type: 'simple', name: 'Transport', presets: transportIds});
